...
// Run with: npx hardhat run scripts/deploy_bnb_testnet.js --network bnbTestnet
...
async function main() {
  console.log("🚀 Starting Celystik Hub deployment on BNB Testnet...");
  ...
  // Print summary
  console.log("\n=== CELYSTIK HUB DEPLOYMENT SUMMARY (BNB TESTNET) ===");
  ...
  console.log(`npx hardhat verify --network bnbTestnet ${celToken.address} "Celystik Token" "CEL" "${ethers.utils.parseEther(initialSupply)}"`);
  console.log(`npx hardhat verify --network bnbTestnet ${protocolTreasury.address} ${celToken.address}`);
  console.log(`npx hardhat verify --network bnbTestnet ${innovationUnits.address} "https://api.celystikhub.com/metadata/{id}" ${celToken.address} ${protocolTreasury.address}`);
  console.log(`npx hardhat verify --network bnbTestnet ${projectStaking.address} ${celToken.address} ${innovationUnits.address}`);
  console.log(`npx hardhat verify --network bnbTestnet ${emissionController.address} ${celToken.address} ${projectStaking.address} ${innovationUnits.address}`);
}
